...
export default function Card({ user }: Props) {
  ...
  return (
    <div
      ...
      className="group flex flex-col gap-y-1 p-3 rounded-md border-2 border-slate-100 hover:border-slate-200 shadow-sm hover:shadow hover:bg-slate-50 duration-200 cursor-pointer">
      <div
